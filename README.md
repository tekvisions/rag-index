...
[![Live](https://img.shields.io/badge/live-rag.kymatalabs.com-5b4bff?style=flat-square)](https://rag.kymatalabs.com)
&nbsp;
![Updated](https://img.shields.io/badge/updated-daily-22c55e?style=flat-square)
&nbsp;
![Indexed](https://img.shields.io/badge/indexed-214%2B-f59e0b?style=flat-square)
&nbsp;
![Built by](https://img.shields.io/badge/built%20by-Kymata%20Labs-111111?style=flat-square)

<a href="https://rag.kymatalabs.com"><img src="./og.png" alt="The RAG Index" width="640"></a>

**[Open the live index →](https://rag.kymatalabs.com)**
...
**The RAG Index** is a living, self-updating directory of retrieval-augmented-generation tooling — RAG frameworks, vector databases, embeddings, reranking, and ingestion.
...
> 🔗 **Live:** [rag.kymatalabs.com](https://rag.kymatalabs.com) · part of [**The Living Indexes**](https://indexes.kymatalabs.com)
...
- 🗂 **8 categories** — `Vector Databases` · `Retrieval & Search` · `RAG Frameworks` · `Reranking` · `Embeddings` · `Graph RAG` · `Ingestion & Parsing` · `Collections`
...
© 2026 **Kymata Labs LLC**. RAG Index is a self-updating reference, recomputed daily.
